...
def load_data() -> Tuple[pd.DataFrame, pd.DataFrame, pd.DataFrame]:
    ...
    try:
        filename = BASE_DIR / "Trade_report.xlsx"
        normalized_filename = unicodedata.normalize('NFC', filename)
        trade_book = pd.read_excel(normalized_filename, engine="openpyxl")
        filename = BASE_DIR / "Trade_report_backtest.xlsx"
        normalized_filename = unicodedata.normalize('NFC', filename)
        trade_book_backtest = pd.read_excel(normalized_filename, engine="openpyxl")
        filename = BASE_DIR / "Market_data.xlsx"
        normalized_filename = unicodedata.normalize('NFC', filename)
        market_data = pd.read_excel(normalized_filename, engine="openpyxl")
